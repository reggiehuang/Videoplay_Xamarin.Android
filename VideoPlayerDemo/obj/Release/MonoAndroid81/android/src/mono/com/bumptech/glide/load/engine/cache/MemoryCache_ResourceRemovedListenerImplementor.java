...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Bumptech.Glide.Load.Engine.Cache.IMemoryCacheResourceRemovedListenerImplementor, Glide", MemoryCache_ResourceRemovedListenerImplementor.class, __md_methods);
	}
	...
	public MemoryCache_ResourceRemovedListenerImplementor ()
	{
		...
		if (getClass () == MemoryCache_ResourceRemovedListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Bumptech.Glide.Load.Engine.Cache.IMemoryCacheResourceRemovedListenerImplementor, Glide", "", this, new java.lang.Object[] {  });
	}
